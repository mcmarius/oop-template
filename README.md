...
În acest proiect puteți folosi o bază de date PostgreSQL. Pentru a fi ușor de folosit am creat un [wrapper](src/database/Database.cpp)
...
- PostgreSQL
  ...
  - Ultima versiune disponibilă: 18.2 (septembrie 2026)
    - Pe CI sunt versiunile 17.11 pe Windows, 18.1 pe Linux și respectiv 17.8 pe macOS
- PQXX
  ...
  - Versiune: [7.10.7](https://github.com/jtv/libpqxx/releases/tag/7.10.7)
