...
- [ ] moșteniri:
  - minim o clasă de bază și 2-3 clase derivate
...
- [ ] STL
- [ ] cât mai multe `const`
- [ ] la sfârșit: commit separat cu adăugarea unei noi clase derivate fără a modifica restul codului, pe lângă cele 2-3 derivate deja adăugate
